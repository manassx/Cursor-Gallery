                    ...
                    >
                        ...
                        <div className="relative">
                            ...
                            <label
                                ...
                                style={{
                                    ...
                                    transform: `translateY(${focusedField === 'name' || formData.name ? '0' : '-50%'}) scale(${focusedField === 'name' || formData.name ? '0.8' : '1'})`,
                        ...
                        <div className="relative">
                            ...
                            <label
                                ...
                                className="absolute left-4 transition-all duration-300 pointer-events-none"
                                style={{
                                    top: focusedField === 'confirmPassword' || formData.confirmPassword ? '8px' : '50%',
                                    transform: `translateY(${focusedField === 'confirmPassword' || formData.confirmPassword ? '0' : '-50%'}) scale(${focusedField === 'confirmPassword' || formData.confirmPassword ? '0.8' : '1'})`,
                                    transformOrigin: 'left top',
                                    color: focusedField === 'confirmPassword' ? currentTheme.accent : currentTheme.textDim,
                                    fontSize: focusedField === 'confirmPassword' || formData.confirmPassword ? '12px' : '16px',
                                }}
                            >
                                Confirm password
                            </label>
